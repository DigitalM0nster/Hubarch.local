...
export default function ContentLeftScreen({ language, projectId, projectData, blockData }: ScreenProps) {
	...
	return (
		<div
			className={`screen active ${styles.screen} ${styles.contentLeftScreen} ${styles.contentLeftRightScreen}`}
