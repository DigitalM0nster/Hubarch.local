		...
		return (
			...
			>
				<div className={styles.image}>
					{index === 0 && <img src="/images/mainPage/screen3/project1.png" alt="" />}
					{index === 1 && <img src="/images/mainPage/screen3/project2.png" alt="" />}
					{index === 2 && <img src="/images/mainPage/screen3/project3.png" alt="" />}
					{index === 3 && <img src="/images/mainPage/screen3/project4.png" alt="" />}
				</div>
